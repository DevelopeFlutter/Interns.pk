...
class JobPost_Title extends StatefulWidget {
  ...
  @override
  State<Reuseable_TextField> createState() => _Reuseable_TextFieldState();
}
class _Reuseable_TextFieldState extends State<Reuseable_TextField> {
...
class Reuseable_TextField extends StatefulWidget {
  const Reuseable_TextField({Key? key}) : super(key: key);
  @override
  State<Reuseable_TextField> createState() => _Reuseable_TextFieldState();
}
class Reuseable_TextFieldState extends State<Reuseable_TextField> {
  TextEditingController jobTitleController = TextEditingController();
  JobPostController getjobTitledata = Get.put(JobPostController());
